(function (root) {
    ...
    function slugg(string, separator, toStrip) {
        ...
        string = string.toLowerCase().replace(toStrip, '').replace(/[\W|_]+/g, separator).replace(new RegExp('^' + separator + '+'), '').replace(new RegExp(separator + '+$'), '');
